    ...
    <div className="flex flex-col h-full w-full items-center justify-center bg-dark-surface rounded-b-lg p-8">
      <div className="text-center">
        <div className="relative inline-block">
          ...
          <span className="absolute bottom-0 right-0 block h-8 w-8 rounded-full bg-green-500 border-4 border-dark-surface animate-pulse" />
        </div>
        <h2 className="text-2xl font-bold mt-6 text-dark-text-primary">Voice Call in Progress</h2>
        <p className="text-dark-text-secondary mt-2">You are connected to your peer.</p>
      </div>
